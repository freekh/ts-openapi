            ...
            return __generator(this, function (_b) {
                ...
                if (isRef(refOr)) {
                    ...
                    if (refHash != '#') {
                        ...
                        return [2 /*return*/, parts.reduce(function (prev, curr) {
                                if (!prev[curr]) {
                                    throw Error("Could not dereference part '" + curr + "' of reference " + refOr.$ref);
                                }
                                return prev[curr];
                            }, this.root)]; // TODO: check if type is correct
                    }
                }
                return [2 /*return*/, refOr]; // TODO: check if type is correct
            });
        });
    };
    return RefStore;
