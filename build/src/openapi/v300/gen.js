        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(Object.keys(properties_1).map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 2:
                    if (!(schema.type == "boolean")) return [3 /*break*/, 3];
                    return [2 /*return*/, ts.createKeywordTypeNode(ts.SyntaxKind.BooleanKeyword)];
                case 3:
                    if (!(schema.type == "number")) return [3 /*break*/, 4];
                    return [2 /*return*/, ts.createKeywordTypeNode(ts.SyntaxKind.NumberKeyword)];
                case 4:
                    if (!(schema.type == "integer")) return [3 /*break*/, 5];
                    return [2 /*return*/, ts.createKeywordTypeNode(ts.SyntaxKind.NumberKeyword)];
                case 5:
                    if (!(schema.type == "string" && schema["enum"])) return [3 /*break*/, 6];
                ...
                case 6:
                    if (!(schema.type == "string")) return [3 /*break*/, 7];
                    return [2 /*return*/, ts.createKeywordTypeNode(ts.SyntaxKind.StringKeyword)];
                case 7:
                    if (!(schema.type == "array" && schema.items)) return [3 /*break*/, 10];
                    _a = convertSchema;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Object.keys(api.paths).reduce(function (endpoints, path) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, operations.reduce(function (endpoint, operation) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_e) {
                                                    switch (_e.label) {
                                                        case 0: return [4 /*yield*/, (operation.parameters || []).reduce(function (prevP, parameterOrRef) { return __awaiter(_this, void 0, void 0, function () {
                                                        ...
                                                        case 3:
                                                            bodySchema = _e.sent();
                                                            if (!bodySchema) return [3 /*break*/, 5];
                                                        ...
                                                        case 6:
                                                            ...
                                                            return [4 /*yield*/, Promise.all(responseValues.map(function (responseValue) { return __awaiter(_this, void 0, void 0, function () {
