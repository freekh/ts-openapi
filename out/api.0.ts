...
export const allPaths = ["/article/conversions", "/article/referrals", "/article/totals", "/article/windows", "/article/content-folder/averages", "/article/content-folder/range/views", "/article/content-folder/referrals", "/article/content-folder/sorted-list", "/article/content-folder/windows", "/radio/podcast/listens"];
export type Paths = "/article/conversions" | "/article/referrals" | "/article/totals" | "/article/windows" | "/article/content-folder/averages" | "/article/content-folder/range/views" | "/article/content-folder/referrals" | "/article/content-folder/sorted-list" | "/article/content-folder/windows" | "/radio/podcast/listens";
